...
const Grants = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-2">MetaplexDAO Grants — Cohort 1</h1>
      ...
      <div className="bg-gray-800 p-6 rounded-lg mb-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          {/* Tech Filter */}
          <div>
            <label htmlFor="tech-filter" className="block mb-2 text-sm">Technology</label>
            <select
              id="tech-filter"
              value={techFilter}
          ...
          {/* Sector Filter */}
          <div>
            <label htmlFor="sector-filter" className="block mb-2 text-sm">Sector</label>
            <select
              id="sector-filter"
              value={sectorFilter}
      ...
      {filteredGrants.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredGrants.map((grant) => (
            <div 
              key={grant.slug} 
              className="bg-gray-800 rounded-lg overflow-hidden border border-gray-700 hover:border-blue-500 cursor-pointer transition-all"
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <Link 
                        ...
                        className="text-orange-500 hover:text-orange-400 text-sm font-medium hover:underline"
                        onClick={(e) => e.stopPropagation()}
                      >
                        Details →
                      </Link>
